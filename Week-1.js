...
// 	hobbies: "Baseball",
// 	getData: function() {return this.dob +"-" + this.occupation}
// 	}
//
// 	console.log(enrique.getData())

// 3. Create an array with at least 4 items inside it. Show how to access two values from the array in two different ways.

// var nlWest = ["Padres", "Giants", "Dodgers", "Diamondbacks", "Rockies"]
//
// console.log(nlWest[0], nlWest[1])
// console.log(nlWest.join(" and "));
