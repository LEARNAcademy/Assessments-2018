...
// 3. Basic sorting: Find the cheapest price -- you are given a list of
// prices and need to find the signle lowest price from the array. Write a
// function that takes in an array of numbers, and returns the lowest price
